...
class AvisControllerTest extends WebTestCase
{
    ...
    public function testShow(): void
    {
        ...
        $fixture->setIdportfolio('My Title');
    ...
    public function testEdit(): void
    {
        ...
        self::assertSame('Something New', $fixture[0]->getIdportfolio());
    }
