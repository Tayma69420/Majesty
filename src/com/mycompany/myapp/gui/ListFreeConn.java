...
public class ListFreeConn extends Form {

    public ListFreeConn(Form previous) {
        setTitle("Connected Freelancer");
      ...
      // Define the desired width and height for the resized image
        ...
        ProjetButton.addActionListener((e) -> {
            ...
            Button PortButton = new Button("Portfolio");
        PortButton.addActionListener((e) -> {
            new HomeFormProt(this).show();
        });
        // Add the ImageView and labels to the form
        addAll(imageViewer, nameLabel, emailLabel,ProjetButton,PortButton);
